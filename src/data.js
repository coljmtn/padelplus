...
// Règle métier : après jeudi 20h → les sessions samedi passent à la semaine suivante
const now = new Date()
...
export const GUIDE_STEPS = [
  ...
  { num: '02', title: 'Session & Court', desc: 'Choisissez entre le Court N°1 (1h30) ou le Court N°2 (1h).' },
...
export const GUIDE_TRANSCRIPT = `"Bienvenue sur PadelPlus ! Pour réserver, commencez par choisir un terrain. Sélectionnez votre session : le Court N°1 pour une session de 1h30, ou le Court N°2 pour une session d'1h. Notez que pour le samedi, les réservations basculent sur la semaine suivante dès le jeudi soir. Entrez votre nom et votre WhatsApp, confirmez, et retrouvez votre reçu dans l'onglet 'Réservations'. À bientôt sur le court !"`
